...
<!-- <script
    ...
    <script>
        ...
        function initMap() {
            ...
            var centerCoordinates = new google.maps.LatLng(<?php echo $row_l['lct_lat']; ?>, <?php echo $row_l['lct_lng']; ?>);
            var defaultOptions = { center: centerCoordinates, zoom: 10 }

            map = new google.maps.Map(mapLayer, defaultOptions);

            <?php while($row_l = $location->fetch_assoc()){ ?>
            var location = new google.maps.LatLng(<?php echo $row_l['lct_lat']; ?>, <?php echo $row_l['lct_lng']; ?>);
